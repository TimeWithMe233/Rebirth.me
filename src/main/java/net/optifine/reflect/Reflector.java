...
public class Reflector {
    ...
    public static boolean postForgeBusEvent(final Object event) {
        if (event == null) {
            ...
            final Object object = getFieldValue(MinecraftForge_EVENT_BUS);

            if (object == null) {
                return false;
            } else {
                final Object object1 = call(object, EventBus_post, event);

                if (!(object1 instanceof Boolean)) {
                    return false;
                } else {
                    final Boolean obool = (Boolean) object1;
                    return obool.booleanValue();
                }
            }
        }
    ...
    private static void dbgCall(final boolean isStatic, final String callType, final ReflectorMethod refMethod, final Object[] params, final Object retVal) {
        ...
        final String s1 = refMethod.getTargetMethod().getName();
        String s2 = "";
    ...
    private static void dbgFieldValue(final boolean isStatic, final String accessType, final ReflectorField refField, final Object val) {
        ...
        final String s1 = refField.getTargetField().getName();
        String s2 = "";
