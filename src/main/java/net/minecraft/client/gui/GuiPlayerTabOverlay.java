...
//import dramdev.socket.Verify.GuiLogin;
...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public String getPlayerName(final NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        if (Objects.equals(originalName, mc.thePlayer.getCommandSenderName())) {
            originalName = EnumChatFormatting.RED + "[" + Client.name + "] " + EnumChatFormatting.GREEN + "[" + Client.location2 + "] " +  EnumChatFormatting.RESET + originalName;
        }
        return originalName;
    }
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    this.mc.fontRendererObj.drawStringWithShadow(s1, (float) j2, (float) k2 + 1, -1862270977);
                } else {
                    this.mc.fontRendererObj.drawStringWithShadow(s1, (float) j2, (float) k2 + 1, -1);
                }
