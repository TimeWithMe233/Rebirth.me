    ...
    private void notifyReloadListeners() {
        for (final IResourceManagerReloadListener iresourcemanagerreloadlistener : this.reloadListeners) {
            if (!(mc.currentScreen instanceof GuiLanguage &&
                    (reloadListeners instanceof FontRenderer ||
                     reloadListeners instanceof com.alan.clients.util.font.impl.rise.FontRenderer)||
                    reloadListeners instanceof TextureManager ||
                    reloadListeners instanceof SoundHandler ||
                    reloadListeners instanceof GrassColorReloadListener ||
                    reloadListeners instanceof FoliageColorReloadListener ||
                    reloadListeners instanceof RenderItem ||
                    reloadListeners instanceof EntityRenderer ||
                    reloadListeners instanceof BlockRendererDispatcher||
                    reloadListeners instanceof RenderGlobal)) {
