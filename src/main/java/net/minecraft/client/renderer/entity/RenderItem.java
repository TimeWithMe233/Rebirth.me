...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public void directRenderItemIntoGUI(final ItemStack stack) {
        if(stack == null){
            return;
        }
        ...
        if (stack.stackSize != 1) {
            ...
            fr.drawStringWithShadow(s, (float) (17 - fr.width(s))*0.2, (float) (9)*0.2, 16777215);
            GlStateManager.popMatrix();
        ...
        if (ReflectorForge.isItemDamaged(stack)) {
            ...
            final Tessellator tessellator = Tessellator.getInstance();
            final WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            this.func_181565_a(worldrenderer, -5, 5, 13, 2, 0, 0, 0, 255);
            this.func_181565_a(worldrenderer, -5, 5, 12, 1, (255 - i) / 4, 64, 0, 255);
            int j = 255 - i;
            int k = i;
            int l = 0;
            ...
            this.func_181565_a(worldrenderer, -5, 5, j1, 1, j, k, l, 255);
            GlStateManager.enableBlend();
            GlStateManager.enableAlpha();
            GlStateManager.enableTexture2D();
            GlStateManager.enableDepth();
    ...
    private void func_181565_a(final WorldRenderer worldRenderer, final int x, final int y, final int width, final int height, final int p_181565_6_, final int p_181565_7_, final int p_181565_8_, final int p_181565_9_) {
        worldRenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
        worldRenderer.pos(x + 0, y + 0, 0.0D).func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        worldRenderer.pos(x + 0, y + height, 0.0D).func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        worldRenderer.pos(x + width, y + height, 0.0D).func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        worldRenderer.pos(x + width, y + 0, 0.0D).func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
