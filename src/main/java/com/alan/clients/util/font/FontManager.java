...
public class FontManager {
    ...
    private static Font getCN(HashMap<Integer, FontRenderer> map, int size, String name, boolean fractionalMetrics, boolean AA) {
        return get(map, size, name, fractionalMetrics, AA, false, true);
    }
    ...
    private static Font get(HashMap<Integer, FontRenderer> map, int size, String name, boolean internationa, boolean fractionalMetrics, boolean AA) {
        return get(map, size, name, fractionalMetrics, AA, false, internationa);
    }
    ...
    private static Font get(HashMap<Integer, FontRenderer> map, int size, String name, boolean fractionalMetrics, boolean AA, boolean otf, boolean international) {
        if (!map.containsKey(size)) {
            final java.awt.Font font = FontUtil.getResource("rebirth/font/" + name + (otf ? ".otf" : ".ttf"), size);
    ...
    public static Font getNunitoLightCN(final int size) {
        return getCN(PRODUCT_SANS_LIGHT, size, "product_sans_light", true, true);
    }
}