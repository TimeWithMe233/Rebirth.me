 ...
 */
package com.alan.clients.util.hyt.party.ui.hyt.party;

import com.alan.clients.util.hyt.party.Sender;
import com.alan.clients.util.hyt.party.ui.hyt.germ.component.impl.ClickableButton;
...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawImage(new ResourceLocation("Rebirth/hyt/background.png"), (float)this.width / 2.0f - 100.0f, (float)this.height / 2.0f - 81.0f, 200.0f, 162.0f, -1);
