...
public class RenderUtil {
    ...
    public static void renderRoundedRect(float x, float y, float width, float height, float radius, int color) {
        ...
        Gui.drawRect(x + radius, y, width - radius * 2, height, color);
        Gui.drawRect(x, y + radius, width, height - radius * 2, color);
    }
    ...
    public static void drawCircleESP(final Entity entity, final double rad, final int color, final boolean shade) {
        GL11.glPushMatrix();
        GL11.glDisable(3553);
        GL11.glEnable(2848);
        GL11.glEnable(2832);
        ...
        final double x = entity.lastTickPosX+ (entity.posX- entity.lastTickPosX) * mc.getTimer().renderPartialTicks - (mc.getRenderManager()).renderPosX;
        final double y = (entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * mc.getTimer().renderPartialTicks - (mc.getRenderManager()).renderPosY) + Math.sin(System.currentTimeMillis() / 2E+2) + 1;
        final double z = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * mc.getTimer().renderPartialTicks - (mc.getRenderManager()).renderPosZ;
