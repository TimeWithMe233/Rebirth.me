...
public class Radar extends Module {
    ...
    private final ResourceLocation radarBeamResource = new ResourceLocation("rebirth/icons/radar/radarbeam.png");
    private final ResourceLocation radarDotResource = new ResourceLocation("rebirth/icons/radar/radardot.png");
    private final ResourceLocation radarScopeResource = new ResourceLocation("rebirth/icons/radar/radarscope.png");
