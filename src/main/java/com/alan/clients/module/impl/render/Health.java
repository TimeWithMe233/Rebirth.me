...
import com.alan.clients.util.Colors;
import com.alan.clients.util.EventRender2D;
import com.alan.clients.util.EventTarget;
import com.alan.clients.util.EventUpdate;
...
@ModuleInfo(name = "Health", description = "Health", category = Category.RENDER, autoEnabled = true)
