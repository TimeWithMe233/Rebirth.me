...
import com.alan.clients.util.ColorU;
...
public class RoundedUtil {
    ...
    public static ShaBi roundedShader = new ShaBi("roundedRect");
    public static ShaBi roundedOutlineShader = new ShaBi("roundRectOutline");
    private static final ShaBi roundedTexturedShader = new ShaBi("roundRectTexture");
    private static final ShaBi roundedGradientShader = new ShaBi("roundedRectGradient");
    ...
    public static void drawGradientCornerLR(float x, float y, float width, float height, float radius, Color topLeft, Color bottomRight) {
        Color mixedColor = ColorU.interpolateColorC(topLeft, bottomRight, .5f);
    ...
    public static void drawGradientCornerRL(float x, float y, float width, float height, float radius, Color bottomLeft, Color topRight) {
        Color mixedColor = ColorU.interpolateColorC(topRight, bottomLeft, .5f);
    ...
    public static void drawGradientRound(float x, float y, float width, float height, float radius, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight) {
       ...
       ShaBi.drawQuads(x - 1, y - 1, width + 2, height + 2);
    ...
    public static void drawRoundOutline(float x, float y, float width, float height, float radius, float outlineThickness, Color color, Color outlineColor) {
      ...
      ShaBi.drawQuads(x - (2 + outlineThickness), y - (2 + outlineThickness), width + (4 + outlineThickness * 2), height + (4 + outlineThickness * 2));
    ...
    private static void setupRoundedRectUniforms(float x, float y, float width, float height, float radius, ShaBi roundedTexturedShader) {
        ScaledResolution sr = new ScaledResolution(Minecraft.getMinecraft());
