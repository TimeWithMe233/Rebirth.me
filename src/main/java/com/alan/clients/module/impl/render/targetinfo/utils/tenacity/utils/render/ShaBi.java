...
import com.alan.clients.module.impl.render.targetinfo.utils.tenacity.utils.FileUtils;
...
public class ShaBi  {
    ...
    public  ShaBi(String fragmentShaderLoc, String vertexShaderLoc) {
    ...
    public ShaBi(String fragmentShadersrc, boolean notUsed) {
        int program = glCreateProgram();
