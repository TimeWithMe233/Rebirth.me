...
public final class SpeedBuilderScreen extends Screen {
    ...
    private ResourceLocation image = new ResourceLocation("rebirth/images/SpeedBuilderBackground.png");
...
//        final Reflections reflections = new Reflections("com.riseclient.rebirth.ui.click.standard.screen.impl.speedbuilder.impl");
//
